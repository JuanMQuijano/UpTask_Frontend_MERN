    ...
    return (
        <div className="border-b p-5 flex flex-col md:flex-row justify-between">
            ...
            <div className="flex items-center gap-2">
                ...
                {auth._id !== creador ? (
                    <p className="p-1 text-sx rounded-lg text-white bg-green-500 font-bold uppercase">Colaborador</p>
                ) : (<p className="p-1 text-sx rounded-lg text-white bg-blue-500 font-bold uppercase">Creador</p>)}
            </div>
